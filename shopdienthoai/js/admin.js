    ...
    for (var i = 0; i < list_products.length; i++) {
        ...
        s += `<tr>
            ...
            <td style="width: 10%">
                ...
                <i class="fa fa-wrench" onclick="addKhungSuaSanPham('` + p.MaSP + `')"><span style="margin-left: 8px;">Sửa</span></i>
                <a class="my_a" href='./php/delete.php?id=`+p.MaSP+`' style="text-decoration: none;"><i class="fa fa-trash"></i> Xóa</a>
...
function addKhungSuaSanPham(masp) {
    ...
    <form method="post" action="./php/update.php" enctype="multipart/form-data" onsubmit="return suaSanPham('` + sp.MaSP + `')">
        <table class="overlayTable table-outline table-content table-header">
            ...
            <tr>
                ...
                <input name="maspSua1" value="` + sp.MaSP + `" hidden>
            </tr>
            <tr>
                <td>Tên sẩn phẩm:</td>
                <td><input name="tenSP" type="text" value="` + sp.TenSP + `"></td>
            </tr>
            <tr>
                <td>Hãng:</td>
                <td>
            ...
            <tr>
                <td>Giá tiền:</td>
                <td><input type="text" name="giaTien" value="` + sp.DonGia + `"></td>
            </tr>
            <tr>
                <td>Số sao:</td>
                <td><input type="text" name="soSao" value="` + sp.SoSao + `"></td>
            </tr>
            <tr>
                <td>Đánh giá:</td>
                <td><input type="text" name="danhGia" value="` + sp.SoDanhGia + `"></td>
            </tr>
            <tr>
                <td>Khuyến mãi:</td>
                <td>
            ...
            <tr>
                ...
                <td><input name="giatrikm" id="giatrikm" type="text" value="0"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Màn hình:</td>
                <td><input name="manHinh" type="text" value="` + sp.ManHinh + `"></td>
            </tr>
            <tr>
                <td>Hệ điều hành:</td>
                <td><input name="hdh" type="text" value="` + sp.HDH + `"></td>
            </tr>
            <tr>
                <td>Camara sau:</td>
                <td><input name="camSau" type="text" value="` + sp.CamSau + `"></td>
            </tr>
            <tr>
                <td>Camara trước:</td>
                <td><input name="camTruoc" type="text" value="` + sp.CamTruoc + `"></td>
            </tr>
            <tr>
                <td>CPU:</td>
                <td><input name="CPU" type="text" value="` + sp.CPU + `"></td>
            </tr>
            <tr>
                <td>RAM:</td>
                <td><input name="ram" type="text" value="` + sp.Ram + `"></td>
            </tr>
            <tr>
                <td>Bộ nhớ trong:</td>
                <td><input name="rom" type="text" value="` + sp.Rom + `"></td>
            </tr>
            <tr>
                <td>Thẻ nhớ:</td>
                <td><input name="sdCard" type="text" value="` + sp.SDCard + `"></td>
            </tr>
            <tr>
                <td>Dung lượng Pin:</td>
                <td><input name="pin" type="text" value="` + sp.Pin + `"></td>
            </tr>
            <tr>
                <td colspan="2"  class="table-footer"> <button type="submit" name="submit">SỬA</button> </td>
            </tr>
        </table>`
        ...
        s += `<tr>
            ...
            <td style="width: 10%">
                ...
                <div class="tooltip">
                    ...
                    <span class="tooltiptext" style="color:#fff">Hủy</span>
                </div>
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        s += `<tr>
            ...
            <td >
                ...
                <div class="">
                    <i style="color:#fff" class="fa fa-remove" onclick="xoaNguoiDung('` + u.MaND + `')">
                        <span class="tooltiptext" style="color:#fff">Xóa</span>
                    </i>
                </div>
            </td>
        </tr>`;
