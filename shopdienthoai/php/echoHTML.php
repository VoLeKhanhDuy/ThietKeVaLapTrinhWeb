...
function footer() {
    echo '
      <div class="footer" style="margin-top: 16px; color: #fff; background-color: #92a8d1; display:flex; height: 200px; boder-radius: 5px;">
        <div class="col-1" style="width: 400px; margin-left: 150px;">
          <h3 style="text-align: center; padding: 16px 0 32px 0;">Hỗ trợ kỹ thuật</h3>
          <div style="margin-bottom: 16px; display: flex;">
            <div style="width: 200px; padding-left: 42px;"><b>Gọi mua hàng</b></div>
            <div style="width: 200px; padding-left: 32px;">1800 1234</div>
          </div>
          <div style="margin-bottom: 16px; display: flex;">
            <div style="width: 200px; padding-left: 42px;"><b>Gọi bảo hành</b></div>
            <div style="width: 200px; padding-left: 32px;">1800 2345</div>
          </div>
          <div style="margin-bottom: 16px; display: flex;">
            <div style="width: 200px; padding-left: 42px;"><b>Hỗ trợ kỹ thuật</b></div>
            <div style="width: 200px; padding-left: 32px;">1800 4567</div>
          </div>
        </div>
        <div class="col-2" style="width: 400px; text-align: center; padding: 50px 0;">
          <img src="img/logo.jpg" width="300" style="cursor: pointer;" >
        </div>
        <div class="col-3" style="width: 400px;">
          <h3 style="text-align: center; padding: 16px 0 32px 0">Địa chỉ</h3>
          <div style="margin-bottom: 16px; display: flex;">
            <p style="padding: 0 42px; line-height: 1.5;">
              <a href="https://goo.gl/maps/4Cq5suMkqW1HuVYE8" target="_blank">
                126 Nguyễn Thiện Thành, Phường 5, Trà Vinh, Việt Nam
              </a>
            </p>
          </div>
        </div>
        ...
        <div class=" taikhoan">
            ...
            <div class="tab-content">
                ...
                <div id="signup">
                    ...
                    <form action="php/_dangky.php" method="post" name="formDangKy">
                        <div class="top-row">
                            <div class="field-wrap">
                                <label>
